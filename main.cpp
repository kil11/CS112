...
int main() {
    ...
    // testing get_restaurants in the main function,
    //     things get a BIT more involved, because need 
    ...
    cout << endl;
    cout << "PLEASE enter First's - Dave's - Mickey Diner when asked:" 
         << endl << endl;
    
    // NOTE how you call a void function!
    //     NOT in a cout! NOT in an assignment statement!
    ...
    cout << endl;
    cout << "faves should NOW contain THOSE names; does it?"
     << endl 
         << "============" << endl;
